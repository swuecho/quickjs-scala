...
**Current Status**: Phase 3 - Substantial language support with most ES2024 features. 1,310 tests passing, 0 failures. 15 test262 smoke test suites. Full test262 sweep (aggregated from per-directory chunks, Sep 18 2026, after the import-attributes/WeakRef/iterator-helpers round): 37,278/49,502 passing (92.5% of executed tests; 9,202 skipped by feature config; 196 failures, 2,786 errors, 40 timeouts). The previous sweep was 36,551/92.4% with 9,948 skipped and 3,003 non-passing; this round enabled 746 more tests and gained 727 passes. 5 QuickJS C test files all passing. The Runner can execute ordinary scripts (including `.mjs` modules) — see "Scripting support" below.
