...
/** Mutable execution frame state for the bytecode interpreter.
  * Bundles all mutable state that was previously local variables inside `call()`.
  */
...
private[interpreter] case class TryHandler(catchPc: Int, finallyPc: Int, stackTop: Int)
