...
/** Error built-in: Error, TypeError, ReferenceError, SyntaxError, RangeError constructors. */
object ErrorBuiltins:
  import quickjs.objmodel.JSObject

  def initialize(ctx: JSContext): Unit =
    def buildError(proto: JSObject, name: String, args: Array[JSValue])(using JSContext): JSValue =
    ...
    val errorPrototype = JSObject(prototype = ctx.objectPrototype, extensible = true)
    ...
    val typeErrorPrototype = JSObject(prototype = errorPrototype, extensible = true)
    ...
    val referenceErrorPrototype = JSObject(prototype = errorPrototype, extensible = true)
    ...
    val syntaxErrorPrototype = JSObject(prototype = errorPrototype, extensible = true)
    ...
    val rangeErrorPrototype = JSObject(prototype = errorPrototype, extensible = true)
