...
object SymbolBuiltins {
  ...
  def initialize(ctx: JSContext): Unit = {
    ...
    ctx.global.defineProperty(
      "Symbol",
      JSValue.Native(symbolConstructor),
      enumerable = false
    )
    ...
    symbolPrototype.defineAccessorProperty(
      "description",
      getter = Some(JSValue.Native(symbolDescriptionGetter)),
      setter = None,
      enumerable = false,
      configurable = true
    )
